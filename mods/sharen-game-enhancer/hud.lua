            ...
            if l.pos.y < posGoal then
                ...
                if l.pos.y > posGoal then
                    ...
                    if i == string.len(sDeathText) and gDeathTextTimer >= DEATH_TEXT_DURATION then
                        gDeathTextTimer = DEATH_TEXT_DURATION + 4 * string.len(sDeathText) + 1
                    end
                end
            end
...
local talk_popup = function(m)
    ...
    if m == nil or m.marioBodyState == nil or m.area == nil or m.area.camera == nil then return end
...
hook_event(HOOK_ON_HUD_RENDER, function()
    ...
    if m == nil or m.controller == nil then return end
