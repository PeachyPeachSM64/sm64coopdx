...
static inline void _debuglog_print_log(const char* logType, const char* filename) {
...
#define LOG_WARNING(...) (configDebugError ? ( _debuglog_print_log("WARNING", __FILE__), printf(__VA_ARGS__), printf("\n") ) : 0)
