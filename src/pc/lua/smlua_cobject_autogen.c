...
static struct LuaObjectField sCharacterFields[LUA_CHARACTER_FIELD_COUNT] = {
    ...
    { "capMetalModelId",                    LVT_S32,       offsetof(struct Character, capMetalModelId),                    true, LOT_NONE                                   },
    { "capMetalWingModelId",                LVT_S32,       offsetof(struct Character, capMetalWingModelId),                true, LOT_NONE                                   },
    { "capModelId",                         LVT_S32,       offsetof(struct Character, capModelId),                         true, LOT_NONE                                   },
    { "capWingModelId",                     LVT_S32,       offsetof(struct Character, capWingModelId),                     true, LOT_NONE                                   },
    ...
    { "modelId",                            LVT_S32,       offsetof(struct Character, modelId),                            true, LOT_NONE                                   },
...
static struct LuaObjectField sSpawnParticlesInfoFields[LUA_SPAWN_PARTICLES_INFO_FIELD_COUNT] = {
    ...
    { "model",           LVT_S32, offsetof(struct SpawnParticlesInfo, model),           true,  LOT_NONE },
...
static struct LuaObjectField sWaterDropletParamsFields[LUA_WATER_DROPLET_PARAMS_FIELD_COUNT] = {
    ...
    { "model",                LVT_S32,              offsetof(struct WaterDropletParams, model),                true,  LOT_NONE    },
