...
This function works with custom object fields as well and is meant to be used with functions that take a field index as paramater, like `obj_get_first_with_behavior_id_and_field_s32` or `obj_get_field_s32`|descriptionEnd| */
