...
struct Object* spawn_macro_abs_yrot_param1(enum ModelExtendedId modelId, const BehaviorScript *behavior, s16 x, s16 y, s16 z, s16 ry, s16 params);
struct Object* spawn_macro_abs_special(enum ModelExtendedId modelId, const BehaviorScript *behavior, s16 x, s16 y, s16 z, s16 unkA, s16 unkB, s16 unkC);
