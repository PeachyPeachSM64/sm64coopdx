 ...
 */
struct Object *spawn_obj_at_mario_rel_yaw(struct MarioState *m, enum ModelExtendedId modelId, const BehaviorScript *behavior, s16 relYaw) {
    if (!m || !behavior) { return NULL; }
    struct Object *o = spawn_object(m->marioObj, modelId, behavior);
