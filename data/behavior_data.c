...
const BehaviorScript bhvMrI[] = {
    ...
    SET_HOME(),
    SPAWN_CHILD(/*Model*/ E_MODEL_MR_I_IRIS, /*Behavior*/ bhvMrIBody),
    SET_MODEL(E_MODEL_MR_I),
    BILLBOARD(),
...
const BehaviorScript bhvKingBobomb[] = {
    ...
    DROP_TO_FLOOR(),
    SET_HOME(),
    SPAWN_OBJ(/*Model*/ E_MODEL_NONE, /*Behavior*/ bhvBobombAnchorMario),
    SET_INT(oHealth, 3),
    SET_INT(oDamageOrCoinValue, 1),
    BEGIN_LOOP(),
...
const BehaviorScript bhvBubbleParticleSpawner[] = {
    ...
    SPAWN_CHILD(/*Model*/ E_MODEL_BUBBLE, /*Behavior*/ bhvSmallWaterWave),
...
const BehaviorScript bhvCannon[] = {
    ...
    SPAWN_CHILD(/*Model*/ E_MODEL_CANNON_BARREL, /*Behavior*/ bhvCannonBarrel),
...
const BehaviorScript bhvChuckya[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SPAWN_OBJ(/*Model*/ E_MODEL_NONE, /*Behavior*/ bhvChuckyaAnchorMario),
...
const BehaviorScript bhvThreeCoinsSpawn[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_REPEAT(3),
        SPAWN_CHILD(/*Model*/ E_MODEL_YELLOW_COIN, /*Behavior*/ bhvSingleCoinGetsSpawned),
    END_REPEAT(),
    DEACTIVATE(),
};
...
const BehaviorScript bhvUkikiCage[] = {
    ...
    SPAWN_CHILD(/*Model*/ E_MODEL_STAR, /*Behavior*/ bhvUkikiCageStar),
    SPAWN_CHILD(/*Model*/ E_MODEL_NONE, /*Behavior*/ bhvUkikiCageChild),
...
const BehaviorScript bhvBitfsSinkingCagePlatform[] = {
    ...
    SET_HOME(),
    SPAWN_CHILD(/*Model*/ E_MODEL_BITFS_BLUE_POLE, /*Behavior*/ bhvDddMovingPole),
    BEGIN_LOOP(),
...
const BehaviorScript bhvHeaveHo[] = {
    ...
    SPAWN_OBJ(/*Model*/ E_MODEL_NONE, /*Behavior*/ bhvHeaveHoThrowMario),
    SET_INT(oInteractType, INTERACT_GRABBABLE),
...
const BehaviorScript bhvPiranhaPlant[] = {
    ...
    SET_INT(oDamageOrCoinValue, 3),
    SET_INT(oNumLootCoins, 5),
    SPAWN_CHILD(/*Model*/ E_MODEL_BUBBLE, /*Behavior*/ bhvPiranhaPlantBubble),
...
const BehaviorScript bhvSushiShark[] = {
    ...
    SPAWN_OBJ(/*Model*/ E_MODEL_NONE, /*Behavior*/ bhvSushiSharkCollisionChild),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 50, /*Downwards offset*/ 50),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 3),
    SET_HOME(),
...
const BehaviorScript bhvMistParticleSpawner[] = {
    ...
    DISABLE_RENDERING(),
    SPAWN_CHILD(/*Model*/ E_MODEL_MIST, /*Behavior*/ bhvWhitePuff1),
    SPAWN_CHILD(/*Model*/ E_MODEL_SMOKE, /*Behavior*/ bhvWhitePuff2),
    DELAY(1),
    DEACTIVATE(),
};
...
const BehaviorScript bhvGhostHuntBoo[] = {
    ...
    SET_FLOAT(oGraphYOffset, 30),
    CALL_NATIVE(bhv_init_room),
    SPAWN_CHILD(/*Model*/ E_MODEL_YELLOW_COIN, /*Behavior*/ bhvCoinInsideBoo),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    CALL_NATIVE(bhv_boo_init),
    BEGIN_LOOP(),
...
const BehaviorScript bhvKoopaRaceEndpoint[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    DROP_TO_FLOOR(),
    SPAWN_CHILD_WITH_PARAM(/*Bhv param*/ 0, /*Model*/ E_MODEL_KOOPA_FLAG, /*Behavior*/ bhvKoopaFlag),
    BEGIN_LOOP(),
...
const BehaviorScript bhvChainChomp[] = {
    ...
    SCALE(/*Unused*/ 0, /*Field*/ 200),
    SPAWN_CHILD_WITH_PARAM(/*Bhv param*/ 0, /*Model*/ E_MODEL_WOODEN_POST, /*Behavior*/ bhvWoodenPost),
    BEGIN_LOOP(),
