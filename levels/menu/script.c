...
const LevelScript level_main_menu_entry_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_TOAD_SAVE_BUTTON,       geo_menu_toad_save_button),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_WALUIGI_SAVE_BUTTON,    geo_menu_waluigi_save_button),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_TOAD_SAVE_BUTTON_FADE,   geo_menu_toad_save_button_fade),
