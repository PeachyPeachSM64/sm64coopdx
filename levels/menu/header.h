...
extern const GeoLayout geo_menu_toad_save_button[];
extern const GeoLayout geo_menu_toad_save_button_fade[];
extern const GeoLayout geo_menu_waluigi_save_button[];
...
extern const Gfx dl_menu_toad_save_button_base[];
