...
in_files = [
    ...
    "src/pc/stub/lag_compensation.h",
    ...
    "src/pc/stub/sync_object.h",
    "src/audio/load.h",
    "src/menu/file_select.h",
    "src/game/photo_mode_poses.h",
]

override_allowed_functions = {
    "src/audio/external.h":                 [ " play_", "fade", "current_background", "stop_", "sound_banks", "drop_queued_background_music", "set_sound_moving_speed", "background_music_default_volume", "get_sound_pan", "sound_get_level_intensity", "set_audio_muted", "set_sequence", "get_current_music_dynamic", "get_current_secondary_music" ],
    ...
    "src/game/mario_misc.h":                [ "bhv_toad.*", "bhv_unlock_door.*", "geo_get_.*_state", " mario_get_", " mario_set_" ],
    ...
    "src/game/area.h":                      [ "get_mario_spawn_type", "area_get_warp_node", "area_get_any_warp_node", "play_transition", "get_curr_" ],
    ...
    "src/audio/seqplayer.h":                [ "sequence_player_" ],
    "src/pc/stub/sync_object.h":            [ "sync_object_is_initialized", "sync_object_is_owned_locally", "sync_object_get_object" ],
...
override_disallowed_functions = {
    ...
    "src/pc/stub/network_utils.h":              [ "network_get_player_text_color[^_]" ],
    "src/pc/stub/network_player.h":             [ "_init", "_connected[^_]", "_shutdown", "_disconnected", "_update", "construct_player_popup", "network_player_name_valid" ],
    ...
    "src/pc/stub/lag_compensation.h":           [ "lag_compensation_clear" ],
    ...
    "src/menu/file_select.h":                   [ "beh_", "bhv_", "geo_", "lvl_" ],
    "src/audio/seqplayer.h":                    [ "sequence_player_disable" ],
}
