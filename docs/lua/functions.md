...
- object_helpers.c
   ...
   - [cur_obj_set_model](functions-6.md#cur_obj_set_model)
   - [obj_set_model](functions-6.md#obj_set_model)
   - [cur_obj_has_model](functions-6.md#cur_obj_has_model)
   - [obj_has_model](functions-6.md#obj_has_model)
   - [cur_obj_get_model_id](functions-6.md#cur_obj_get_model_id)
   - [obj_get_model_id](functions-6.md#obj_get_model_id)
