...
## [djui_is_player_menu_open](#djui_is_player_menu_open)

### Description
Checks if the DJUI player menu is open

### Lua Example
`local booleanValue = djui_is_player_menu_open()`
...
### Lua Example
`local integerValue = get_menu_mode()`
...
## [get_curr_play_mode](#get_curr_play_mode)

### Description
Gets the current play mode (`sCurrPlayMode`)

### Lua Example
`local integerValue = get_curr_play_mode()`
